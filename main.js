...
(function () {
    ...
    (function () {
        ...
        var currentHint = -1,
            hints = [
                "To get the code for the keypad on the wall, you will first need to find the secret string...",
                "The inside of the locker door tells you how to convert the letters to numbers...",
                "Based on what you find...",
                "The number for letter I is 8, right ?",
                "Once the numbers have been entered into the keypad, the network rack will appear...",
                "These will stay OFF until you insert the ID card in the card reader",
                "Try looking at the floor for the ID card...",
                "Do any tiles look different to you?",
                "Green lights on all rack devices means that all is up and Online",
